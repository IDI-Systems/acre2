...
RPC_FUNCTION(updateSelf) {
    ...
    const acre::Vector3<float32_t> listenerPos(vMessage->getParameterAsFloat(0), vMessage->getParameterAsFloat(2), vMessage->getParameterAsFloat(1));
    const acre::Vector3<float32_t> listenerDir(vMessage->getParameterAsFloat(3), vMessage->getParameterAsFloat(5), vMessage->getParameterAsFloat(4));
