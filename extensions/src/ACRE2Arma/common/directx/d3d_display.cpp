...
namespace acre {
    namespace debug {
        ...
        bool d3d_display::create(uint32_t width = 1024, uint32_t height = 768, bool fullscreen = false) {
            ...
            wcex.lpfnWndProc = (WNDPROC)&acre::debug::d3d_display::wndproc;
            wcex.cbClsExtra = 0;
            wcex.cbWndExtra = 0;
        ...
        void d3d_display::_move_camera(acre::vector3<float> direction) {
            
        }
        void d3d_display::_rotate_camera(acre::vector3<float> direction) {
