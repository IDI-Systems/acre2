...
namespace acre {
    namespace p3d {
        ...
        model_info::model_info(std::istream & stream_, const uint32_t lod_count, uint32_t version)
            ...
            offset_1 = acre::vector3<float>(stream_);
            ...
            center_of_gravity = acre::vector3<float>(stream_);
            offset_2 = acre::vector3<float>(stream_);
            cog_offset = acre::vector3<float>(stream_);

            mass_vectors[0] = acre::vector3<float>(stream_);
            mass_vectors[1] = acre::vector3<float>(stream_);
            mass_vectors[2] = acre::vector3<float>(stream_);
