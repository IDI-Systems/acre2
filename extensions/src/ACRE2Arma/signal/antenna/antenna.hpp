    ...
    namespace signal {
        ...
        public:
            antenna() : _gain_map(nullptr), _min_frequency(0.0f), _max_frequency(0.0f), _frequency_step(0.0f), _elevation_step(0.0f), _direction_step(0.0f),
                _total_entries(0), _width(0), _height(0), _polarization(AntennaPolarization::vertical) , _internalLos_dBm(3.0f){ };
            antenna(std::istream & stream_, const AntennaPolarization polarization_, const float32_t internalLoss_dBm_ );
            antenna(std::istream &stream_) : antenna(stream_, AntennaPolarization::vertical, 3.0f) {};
            ...
            AntennaPolarization getPolarization();
            void setPolarization(const AntennaPolarization polarization_);
        ...
        protected:
            ...
            AntennaPolarization _polarization;
