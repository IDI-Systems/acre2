...
if args.publish:
    ...
    if current_branch != "release-build":
        ...
        do_action(["git", "checkout", "../README.md"], "Failed to checkout previous README.md version.", ignore_failure=True)
    ...
    if(status_ok): # Only diff and push if merge was successful
        ...
        do_action(["git", "push", "origin", target_branch], "Failed to push changes back into branch 'origin/{}'".format(target_branch), ignore_failure=True)
