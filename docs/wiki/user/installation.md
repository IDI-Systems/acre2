...
- Create a new shortcut or edit an existing one, and add `@acre2` and `@CBA_A3` to the `-mod` parameter (for a longer explanation see [this tutorial](https://web.archive.org/web/20210218115054/https://www.armaholic.com/forums.php?m=posts&q=20866))
