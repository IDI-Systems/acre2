...
namespace acre {
    namespace debug {
        ...
        protected:
            void                                _move_camera(acre::vector3<float>);
            void                                _rotate_camera(acre::vector3<float>);
        ...
        struct d3d_display_worker {
            d3d_display_worker(d3d_display * obj, d3d_display_worker_args args) : thread(&acre::debug::d3d_display::render_worker, obj, args) {}
