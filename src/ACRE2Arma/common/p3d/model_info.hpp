...
namespace acre {
    namespace p3d {
        ...
        public:
            ...
            acre::vector3<float>  offset_1;                   // model offset (unknown functionality),//mostly same as offset2
            ...
            acre::vector3<float>  center_of_gravity;          // pew.GeometryAutoCenterPos (and mostly pew.ResolutionAutoCenterPos too)
            acre::vector3<float>  offset_2;                  // mostly same as Offset1 often same as CentreOfGravity (but it isn't ResolutionPos)
            acre::vector3<float>  cog_offset;                // see below
            acre::vector3<float>  mass_vectors[3];      // for ODOL7 this is a mixture of floats and index values
                                                       //// if Arma3 /////////////////
