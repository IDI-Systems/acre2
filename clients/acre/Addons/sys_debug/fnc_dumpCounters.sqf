...
diag_log text format["REGISTERED ACRE PFH HANDLERS"];
...
diag_log text format["COUNTER RESULTS"];
diag_log text format["-------------------------------------------"];
{
...
// Dump PFH Trackers
diag_log text format["ACRE_PERFORMANCE_EXCESSIVE_STEP_TRACKER"];
diag_log text format["-------------------------------------------"];
{
	private["_delay"];
	_delay = _x select 2;
...
} forEach ACRE_PERFORMANCE_EXCESSIVE_STEP_TRACKER;

// Dump PFH Trackers
diag_log text format["ACRE_PERFORMANCE_EXCESSIVE_FRAME_TRACKER"];
diag_log text format["-------------------------------------------"];
{
	private["_delta"];
	_delta = _x select 1;
...
} forEach ACRE_PERFORMANCE_EXCESSIVE_FRAME_TRACKER;
