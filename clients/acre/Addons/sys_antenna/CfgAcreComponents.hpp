...
class CfgAcreComponents {
	...
	class ACRE_BaseAntenna : ACRE_ComponentBase {
		...
		height 			= 1.2; //meters
        binaryGainFile  = "\idi\clients\acre\addons\sys_antenna\binary\VHF_1.2m_whip_gain.aba";
	};
	...
	class ACRE_14IN_UHF_TNC : ACRE_BaseAntenna {
		...
		heightAG		= AVERAGE_MAN_HEIGHT;
        binaryGainFile  = "\idi\clients\acre\addons\sys_antenna\binary\UHF_14_inch_gain.aba";
	};
	...
	class ACRE_13IN_UHF_BNC : ACRE_BaseAntenna {
        ...
        binaryGainFile  = "\idi\clients\acre\addons\sys_antenna\binary\UHF_13_inch_gain.aba";
	};
	...
	class ACRE_2HALFINCH_UHF_TNC : ACRE_BaseAntenna {
        ...
        binaryGainFile  = "\idi\clients\acre\addons\sys_antenna\binary\UHF_2.5_inch_gain.aba";
	};
	...
	class ACRE_OE303_VHF_BNC : ACRE_BaseAntenna {
		...
		connector 		= ACRE_CONNECTOR_BNC;
		height 			= 0.062457; //meters
        binaryGainFile  = "\idi\clients\acre\addons\sys_antenna\binary\oe303_gain.aba";
	};
};