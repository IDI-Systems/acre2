...
class PRC148_RadioDialog {
    ...
    class PRC148Background: Prc148_RscBackground {
        ...
        text = "";//PATHTOF(Data\static\prc148_ui_backplate.paa);
    };
    ...
    class controls {
        ...
        BEGIN_CONTROL(ChannelKnobImage, Prc148_RscPicture, 99902)
            ...
            h = NEW_SCALE*safeZoneH;
            colorText[] = {1,1,1,1};
            text = PATHTOF(Data\knobs\channel\prc148_ui_chan_0.paa);
        END_CONTROL
        ...
        BEGIN_CONTROL(VolumeKnobImage, Prc148_RscPicture, 99903)
            ...
            h = NEW_SCALE*safeZoneH;
            colorText[] = {1,1,1,1};
            text = PATHTOF(Data\knobs\volume\prc148_ui_vol_0.paa);
        END_CONTROL
        ...
        BEGIN_CONTROL(Display, Prc148_RscPicture, 99911)
            ...
            h = NEW_SCALE*safeZoneH;
            colorText[] = {1,1,1,1};
            text = PATHTOF(Data\static\prc148_ui_display.paa);
        END_CONTROL
        ...
        BEGIN_CONTROL(KeypadImage, Prc148_RscPicture, 99901)
            ...
            h = NEW_SCALE*safeZoneH;
            colorText[] = {1,1,1,1};
            text = PATHTOF(Data\knobs\keypad\prc148_ui_keys_default.paa);
        END_CONTROL
        ...
        class BatteryImage: Prc148_RscPicture {
            ...
            h = SCALE*0.055*SafeZoneH;

            text = PATHTOF(Data\battery2_ca.paa);
            idc = 12011;
        };
        ...
        class SquelchImage: Prc148_RscPicture {
            ...
            h = SCALE*0.022*SafeZoneH;
            text = PATHTOF(Data\squelch2_ca.paa);
            idc = 12012;
        };
        ...
        class ExternalAudio: Prc148_RscPicture {
            ...
            h = SCALE*0.013*SafeZoneH;
            text = PATHTOF(Data\external_audio_ca.paa);
            idc = 12013;
        };
        ...
        class SideConnector: Prc148_RscPicture {
            ...
            h = SCALE*0.013*SafeZoneH;
            text = PATHTOF(Data\side_connector_ca.paa);
            idc = 12014;
        };
        ...
        BEGIN_CONTROL(BUTTON_ALT, Prc148_RscButton, 12010+110)
            BUTTON_GRID(0,2);
            w = SCALE*0.029*SafeZoneH;
            h = SCALE*0.037*SafeZoneH;
            text = "";
            onMouseButtonUp = QUOTE(['ALT'] call FUNC(onButtonPress));
        END_CONTROL

        BEGIN_CONTROL(BUTTON_VOLUME, Prc148_RscButton, 12010+201)
            x = ((((0.41-0.5)*SCALE)+0.5) * SafeZoneH) + SafeZoneY;
            y = ((((0.1-0.5)*SCALE)+0.5) * SafeZoneH) + SafeZoneY;
            w = SCALE*0.0435*SafeZoneH;
            h = SCALE*0.042*SafeZoneH;
            text = "";
            colorText[] = {ClrWhite,1};
            colorBackground[] = {ClrGray, 0};
            colorFocused[] = {ClrGray,0};
            sizeEx = SCALE*0.0205*SafeZoneH;
        ...
        BEGIN_CONTROL(BUTTON_CHANNEL, Prc148_RscButton, 12010+202)
            x = ((((0.480-0.5)*SCALE)+0.5) * SafeZoneH) + SafeZoneY;
            y = ((((0.1-0.5)*SCALE)+0.5) * SafeZoneH) + SafeZoneY;
            w = SCALE*0.0435*SafeZoneH;
            h = SCALE*0.052*SafeZoneH;
            text = "";
            colorText[] = {ClrWhite,1};
            colorBackground[] = {ClrGray, 0};
            colorFocused[] = {ClrGray,0};
