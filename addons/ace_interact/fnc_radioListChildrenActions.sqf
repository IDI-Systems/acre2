...

{
    ...
    private _action = [_x, _displayName, _picture, {}, {true}, {_this call FUNC(radioChildrenActions)}, [_x,_isActive, _pttAssign]] call FUNC(createAction);
...
if (count _radioList > 0) then {
    ...
    private _action = ["acre_toggle_headset", _text, "", {[] call EFUNC(sys_core,toggleHeadset)}, {true}, {}, []] call FUNC(createAction);
    _actions pushBack [_action, [], _target];
};
