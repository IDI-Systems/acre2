...
switch (_action) do {
    case 0: {
        ...
        [[format [localize LSTRING(infantryPhoneDisconnected), _intercomText]], [ICON_RADIO_CALL]] call CBA_fnc_notify;
    ...
    case 1: {
        ...
        [[format [localize LSTRING(infantryPhoneConnected), _intercomText]], [ICON_RADIO_CALL]] call CBA_fnc_notify;
    ...
    case 2: {
        ...
        [[format [localize LSTRING(infantryPhoneReceived), _intercomText]], [ICON_RADIO_CALL], nil, _unit] call CBA_fnc_notify;
    };
    case 3: {
        _vehicle setVariable [QGVAR(unitInfantryPhone), [_unit, _intercomNetwork], true];
        _unit setVariable [QGVAR(vehicleInfantryPhone), [_vehicle, _intercomNetwork], true];
