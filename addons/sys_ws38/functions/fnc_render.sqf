...
if (_currentView == 0) then {
    ...
    RADIO_CTRL(106) ctrlSetText format ["\idi\acre\addons\sys_ws38\Data\knobs\channel\prc343_ui_pre_%1.paa", _currentChannel + 1];
    RADIO_CTRL(107) ctrlSetText format ["\idi\acre\addons\sys_ws38\Data\knobs\volume\prc343_ui_vol_%1.paa", _currentVolumeKnobState];
