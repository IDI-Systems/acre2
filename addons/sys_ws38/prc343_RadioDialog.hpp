...
class WS38_RadioDialog {
    ...
    class controls {
        ...
        BEGIN_CONTROL(ChannelKnobButton,Ws38_RscButton,201)
            ...
            text = "";
            onMouseButtonUp = "[_this,0] call acre_sys_ws38_fnc_onChannelKnobPress";
            toolTip = ECSTRING(sys_radio,ui_ChangeChannel);
        END_CONTROL

        BEGIN_CONTROL(VolumeKnob,Ws38_RscPicture,107)
            x = QUOTE(((0.5-(NEW_SCALE*(safeZoneH)/2))));
            y = QUOTE(((0.5-(NEW_SCALE*(safeZoneH)/2))));
            w = QUOTE(NEW_SCALE*safeZoneH);
            h = QUOTE(NEW_SCALE*safeZoneH);
        ...
        BEGIN_CONTROL(VolumeKnobButton,Ws38_RscButton,202)
        ...
        BEGIN_CONTROL(PTTHandleButton,Ws38_RscButton,203)
        ...
        BEGIN_CONTROL(ChannelBlockButton,Ws38_RscButton,204)
            ...
            text = "";
            onMouseButtonUp = "[_this,1] call acre_sys_ws38_fnc_onChannelKnobPress";
