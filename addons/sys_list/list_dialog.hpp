...
class GVAR(radioCycleDisplayFlash): RscControlsGroupNoScrollbars {
    ...
    class controls {
        class GVAR(CycleDialogBackgroundColor): RscText {
...
class GVAR(radioCycleDisplay): RscControlsGroupNoScrollbars {
    ...
    class controls {
        ...
        class GVAR(CycleDialogBackgroundBlack): GVAR(CycleDialogBackgroundColor) {
        ...
        class GVAR(CycleDialogTitle): RscText {
        ...
        class GVAR(CycleDialogLine1): GVAR(CycleDialogTitle) {
        ...
        class GVAR(CycleDialogLine2): GVAR(CycleDialogLine1) {
