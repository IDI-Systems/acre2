...
/*
 * Author: ACRE2Team
 * Check if the radio is mountable in AN/VRC64 rack.
 *
 * Arguments:
 ...
 *
 * Example:
 * [cursorTarget] call acre_sys_rack_fnc_vrc64MountableRadio
 *
 * Public: No
 */
...
if (_baseClass in ["acre_prc77"]) then { _mountable = true; };
